...
namespace SistemaMAV
{
    ...
    {   
        ...
        private void txbBusqueda_TextChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand consulta = MenuPrincipal.DefinirConsultaSPar("sp_Buscar_Tipo_Solicitante_PorNombre_Reduc", "@pTipo_Solicitante", txbBusqueda.Text, SqlDbType.VarChar, MenuPrincipal.cn);
        ...
        private void dgVistaTabla_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (dgVistaTabla.CurrentRow.Cells[0].Value.ToString() != string.Empty)
            {
                ...
                SqlCommand consulta = MenuPrincipal.DefinirConsultaSPar("sp_Obtener_Datos_TiposSolicitante", "@pID_Tipo_Solicitante", pMatricula, SqlDbType.VarBinary, MenuPrincipal.cn);
                SqlDataReader respuesta = consulta.ExecuteReader();
                respuesta.Read();

                //obtenemos los datos de la base de datos
                txbID.Text = respuesta["ID_Tipo_Solicitante"].ToString();
                txbTipoSolicitante.Text = respuesta["Tipo_Solicitante"].ToString();
        ...
        {
            if (MenuPrincipal.ValidarCamposVacios(txbTipoSolicitante.Text))
            {
                //hacemos la consulta
                SqlCommand consulta = MenuPrincipal.DefinirConsultaSPar("sp_Anadir_Tipo_Solicitante", "@pTipo_Solicitante", txbTipoSolicitante.Text, SqlDbType.VarChar, MenuPrincipal.cn);
                ...
                {
                    MessageBox.Show("No se pudo agregar el tipo de solicitante", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
        ...
        private void EditarUsuario()
        {
            ...
            parametros.Add("@pID_Tipo_Solicitante");
            parametros.Add("@pTipo_Solicitante");

            //definimos los valores de los parametros
            List<string> valores = new List<string>();
            valores.Add(txbID.Text);
            valores.Add(txbTipoSolicitante.Text);
            ...
            {
                //hacemos la consulta
                SqlCommand consulta = MenuPrincipal.DefinirConsultaNPar("sp_Editar_Tipo_Solicitante", parametros, valores, tipos, MenuPrincipal.cn);
                ...
                {
                    MessageBox.Show("No se pudo editar el tipo de solicitante", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
        ...
        {
            //hacemos la consulta
            SqlCommand consulta = MenuPrincipal.DefinirConsultaSPar("sp_Eliminar_Tipo_Solicitante", "@pID_Tipo_Solicitante", txbID.Text, SqlDbType.TinyInt, MenuPrincipal.cn);
            ...
            {
                MessageBox.Show("No se pudo eliminar el tipo de solicitante", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        {
            txbTipoSolicitante.Enabled = true;
        }
        ...
        {
            txbID.Enabled = false;
            txbTipoSolicitante.Enabled = false;
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Debes seleccionar un Tipo de solicitante existente", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                //activamos todos los controles
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Debes seleccionar un tipo de solicitante existente para eliminar", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        {
            MenuPrincipal.AsignarTitulo("Consultar tipos de solicitantes");
            MenuPrincipal.abrirPantallas(new ConsultarTiposSolicitante());
        }
